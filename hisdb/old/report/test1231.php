...
if(isset($_GET['searchField'])&&$_GET['searchString']!=''){
		if($searchOper=='eq'){
			...
			$SQL="select MRN, Name,Newic,Oldic,DOB,Sex,idnumber from patmast WHERE MATCH($searchField) AGAINST('$searchString*' IN BOOLEAN MODE) and compcode='$compid' ORDER BY $sidx $sord LIMIT $start , $limit ";
		}
}else{
