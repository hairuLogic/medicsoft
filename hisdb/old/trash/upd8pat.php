...
<body>
    <div id="dialogcr8">
            ...
            <div id="menu">
            <button  type="button" onClick="window.close();">Exit</button><button id="submit" type="submit">Add</button><button type="button"  value="" disabled='true'>Update</button><button type="button" value="" onClick="window.close();">Cancel</button><button type="button" value="" disabled='true'>Delete</button>
            </div>
                <div class="alongdiv">
                    ...
                    <div class="bodydiv">
                    	<table>
                           	<tr>
                            <td><label for="name">Name: </label></td><td><input name="name" type="field" class="ui-corner-all" id="name" /></td>
                            <td><label for="newic">New IC: </label></td><td><input name="newic" type="field" class="ui-corner-all" id="newic" /></td>
                            <td><label for="oldic">Old IC: </label></td><td><input name="oldic" type="field" class="ui-corner-all" id="oldic" /></td></tr>
                      	</table>
                    </div>
                </div>
