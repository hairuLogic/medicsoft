...
$(function() {
	...
	$("#navside #filesetup li a").click(function(){
		var det=$(this).text();
		window.open('allsetup.php?table='+det);
	});
...
<h3>User: <?php echo $_SESSION['username'];?><a href="logout.php"> Log out</a></h3>
</div>
<div id="wrapper">
<div id="navside">
		<h2>Patient</h2>
        <ol id="patient">
        	<li><a href="#" id="winrp" goto="patregistration.php">Registration</a></li>
            <li><a href="#" id="winrp" >Episode</a></li>
        </ol>
        <h2>Order Entry</h2>
        <ol id="ordentry">
        ...
        <h2>Report</h2>
        <ol id="report">
            <li><a href="#" goto="reportofpatient.php" id="rpdf">Report - PDF</a></li>
            <li><a href="#" goto="fixedexcel.php" id="rxls">Report - EXCEL</a></li>
            <li><a href="#" goto="statistics.php" id="stats">Statistics</a></li>
        </ol>
</div>
