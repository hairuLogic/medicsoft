...
<body><?php include("../../include/header.php")?><span id="pagetitle">Country Setup</span>
	...
	<div id="formmenu">
       ...
       <!-- <div id="toggler">Change Table</div>
        ...
        <td width="30%"  style="padding:0px 5px;"><input type="text" id="desc" name="Description" class="req"/></td>
