...
<title>Relationship Setup</title>
</head>

<body><?php include("../../include/header.php")?><span id="pagetitle">Relationship Setup</span>
	...
	<div id="formmenu">
       ...
       <!-- <div id="toggler">Change Table</div>
        ...
        <tr><th style="padding:0 5px;"><label>Code</label></th><th><label>Description</label></th><th><label>Created By</label></th><th><label>Created Date</label></th></tr>
