<?php
	...
	$objPHPExcel->getActiveSheet()->setCellValue('B2','MRN');
	$objPHPExcel->getActiveSheet()->setCellValue('C2','NEWIC');
	...
	$sql="select mrn,name,newic,dob,AddDate,sex from membership where AddDate between '{$from}' and '{$to}' order by sex,AddDate,MRN";
	$res=mysql_query($sql);
