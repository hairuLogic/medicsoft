...
<script>
	...
	$(function(){
		...
		$('#viewbut').click(function(){
			window.open('registerpat.php?det=upd&mrn='+updmrn,"_self");
		});
		$('#addbut').click(function(){
			window.open('registerpat.php?det=rgd&mrn=',"_self");
		});
...
<body><?php include("../../include/header.php")?><span id="pagetitle">Membership List</span>
	<div id="formmenu">
    	<div id="menu">
        ...
        <div class="placeholder">Membership List</div>
