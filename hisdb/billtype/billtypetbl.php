...
$SQL = "select sysno,pkgcode,description,pkgflag,addby,adddate from $table ORDER BY $sidx $sord LIMIT $start , $limit";
...
while($row = mysql_fetch_array($result,MYSQL_NUM)) {
	...
	echo "<cell><![CDATA[". yesno($row[3])."]]></cell>";
	echo "<cell><![CDATA[". $row[4]."]]></cell>";
	echo "<cell><![CDATA[". chgdate($row[5])."]]></cell>";
	echo "</row>";
}
echo "</rows>";	
?>
