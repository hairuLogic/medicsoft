...
Address1,Address2,Address3,OffAdd1,OffAdd2,OffAdd3,telh,telo,mrn,b.name AS agent,c.description as pakage
 FROM membership AS a,agent AS b,pkgmast AS c WHERE c.pkgcode=a.pkgcode AND b.agentcode=a.agentcode AND a.compcode='{$compcode}' AND MemberNo='{$MemberNo}' AND category='subscriber'";
