...
session_start();
    ...
    if($opStatus == 'insert'){
        ...
        $myquery = "INSERT INTO chargetrx (compcode,mrn,episno,trxdate,trxtime,trxtype,chgcode,quantity) VALUES ('$compcode','$mrn','$episno',now(),now(),'$trxtype','$chgCode','$quantity')";
