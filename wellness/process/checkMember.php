<?php
	...
	if($count=="1"){
		$result=mysql_query("SELECT a.memberno,a.name as membername,b.agentcode,b.name as agentname FROM membership a,agent b WHERE b.agentcode=a.agentcode AND a.compcode ='$compcode' $agentSql AND a.category='SUBSCRIBER' $addSql");
		$row = mysql_fetch_row($result,MYSQL_ASSOC);
