        ...
        <script>
			...
			$(function(){
				...
				$("#orderButton").click(function(){
					...
					//togle table
					//$("#tablePt").jqGrid().setGridState("hidden");
				...
				$("#listButton").click(function(){
					...
					$(this).toggleClass("active");
					//togle table
					//$("#tablePt").jqGrid().setGridState("visible");
					$(".ptList").slideToggle( "fast" );
					$(".tableDetail").slideToggle( "fast" );
					return false;
				});
    ...
    <body>
        ...
        <?php include("../include/start.php")?>
            ...
            <div class="body-inner">
                ...
                <span class="divider"  style="margin:2px"></span>
        <div id="ptOrder" style="display: none;"> 
            <div class="content-header" >
                <div class="header-inner">
                    <h2 id="content-main-heading" class="title2">Order Entry</h2>                   
                </div>
            </div>
            <div class="content-body" >
                <div class="body-inner">
                                	...
                                	<table border="0" cellspacing="0" cellpadding="0" style="padding-left: 12px;">
                                        <form name="form1" method="post" action="">
                                            ...
                                            <tr>
                                                ...
                                                <td width="343"><input type="text" name="chgDesc" id="chgDesc" size="60" disabled></td>
